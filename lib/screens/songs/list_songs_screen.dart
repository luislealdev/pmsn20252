...
import 'package:pmsn20252/widgets/songs_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // Aquí puedes agregar navegación a una pantalla para agregar canciones
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Función para agregar canciones próximamente'),
